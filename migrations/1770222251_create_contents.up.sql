...
CREATE INDEX IF NOT EXISTS idx_content__search_vector ON content USING GIN (search_vector);
CREATE INDEX IF NOT EXISTS idx_content__type ON content (type);
CREATE INDEX IF NOT EXISTS idx_content__created_at ON content (created_at);
CREATE INDEX IF NOT EXISTS idx_content__updated_at ON content (updated_at);
